...
class UserService()(implicit session: Session) extends securesocial.core.services.UserService[LoginUser] {
  ...
  private def saveNewProfile(profile: BasicProfile): Future[LoginUser] = {
